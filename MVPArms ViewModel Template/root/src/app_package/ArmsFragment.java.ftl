...
import com.jess.arms.base.BaseVMFragment;
...
<@gb.fileHeader />
public class ${pageName}Fragment extends BaseVMFragment<Fragment${pageName}Binding,${pageName}ViewModel> implements ${pageName}Contract.View{
