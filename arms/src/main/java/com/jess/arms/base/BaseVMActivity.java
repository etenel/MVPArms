 ...
 * ================================================
 */
public abstract class BaseVMActivity<V extends ViewDataBinding, VM extends BaseViewModel> extends AppCompatActivity implements IActivity, ActivityLifecycleable {
    ...
    @Inject
    @Nullable
    protected VM mViewModel;//如果当前页面逻辑简单, ViewModel 可以为 null
    protected V binding;
